    ...
    >
      ...
      <div className="container relative z-[1] max-w-[1260px] mx-auto">
        <div className="text-center ">
          <h2 className="text-[120px] text-white font-bold leading-none tracking-[-4px] mb-5 max-xl:text-[90px] max-lg:text-7xl max-md:text-4xl max-md:tracking-[-1.44px]">
          Grow your firm
          </h2>
          <p className="max-w-[708px] mx-auto mb-[60px] text-2xl leading-10 text-[#C5CEE6]">Expand and elevate your firm with innovative solutions designed to drive growth and success.</p>
        </div>
        <div
          className="col-span-12 bg-cover pt-[60px] ps-[50px]  rounded-[32px] overflow-hidden max-lg:pl-0"
          style={{
        ...
        >
          <div className="grid grid-cols-12 gap-[10px] items-stretch max-lg:gap-0 max-md:grid-cols-1">
            <div className=" col-span-5  max-lg:col-span-6 max-md:px-7 max-md:pt-8 max-md:mb-[-20px] flex flex-col justify-between">
              <div>
                ...
                <p className="text-[23px] font-normal leading-10 text-[#ffffffcd]  mx-auto max-xl:text-[22px] max-md:text-sm ">
