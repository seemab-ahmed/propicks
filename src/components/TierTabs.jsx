...
const TierTabs = ({ TabHeading, tiers }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 text-white mt-6">
      {/* Tab Content Pane */}
      ...
      {/* Tab Button List */}
      <div className="md:col-span-5 flex md:flex-col bg-[#03081847] border border-solid border-[rgba(255,255,255,0.1)] rounded-[32px] p-10 gap-3 max-lg:p-7">
        <h4 className="text-[32px] font-bold leading-none text-white mb-1 tracking-[-0.04em] max-lg:text-[28px]">
          {TabHeading}
        </h4>
        ...
        {tiers.map((tier) => (
          ...
          >
            <span className="w-[35px] h-[35px] text-base leading-[35px] text-center mr-3 px-1 rounded-full border border-solid border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.1)]">
              {tier.id}
            </span>{" "}
